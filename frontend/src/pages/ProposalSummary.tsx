                                                              ...
                                                              <div>
                                                                {/* Column Headers */}
                                                                                                                                ...
                                                                                                                                <div className="flex items-center gap-2">
                                                                                                                                  ...
                                                                                                                                  <button onClick={handleAddLaborRole} className="relative flex items-center justify-center rounded-full font-poppins font-semibold text-white text-sm hover:opacity-90 transition-opacity overflow-hidden flex-shrink-0" style={{ backgroundColor: '#99C8CA', width: '100px', height: '32px' }}>
                                                                                                                                    <span>Add Role</span>
                                                                                                                                    <img src={AddIcon} alt="" className="absolute right-0 top-0 h-full" />
                                                                                                                                  </button>
                                                              ...
                                                              <div>
                                                                {/* Column Headers */}
                                                                                                                                ...
                                                                                                                                <div className="flex items-center gap-2">
                                                                                                                                  ...
                                                                                                                                  <button onClick={handleAddMaterial} className="relative flex items-center justify-center rounded-full font-poppins font-semibold text-white text-sm hover:opacity-90 transition-opacity overflow-hidden flex-shrink-0" style={{ backgroundColor: '#99C8CA', width: '100px', height: '32px' }}>
                                                                                                                                    <span>Add Item</span>
                                                                                                                                    <img src={AddIcon} alt="" className="absolute right-0 top-0 h-full" />
                                                                                                                                  </button>
                                                                                                                                  <button className="p-1 opacity-30 flex-shrink-0">
