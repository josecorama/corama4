...
const ResetPassword = () => {
  ...
  return (
    <div className="min-h-screen bg-[#0B0B0F]">
      ...
      {/* Reset Password Form */}
      <div className="pt-20 sm:pt-32 pb-24 sm:pb-32 px-4 sm:px-6 flex items-center justify-center min-h-screen">
        <div className="w-full max-w-md">
          <div className="bg-gradient-to-br from-[#1c4262] to-[#0f1419] border border-corama-teal/20 rounded-2xl p-5 sm:p-12 shadow-2xl">
            {/* Logo */}
            <div className="text-center mb-5 sm:mb-8">
              ...
              />
              <h1 className="font-poppins text-xl sm:text-2xl text-white mb-2">Reset Password</h1>
