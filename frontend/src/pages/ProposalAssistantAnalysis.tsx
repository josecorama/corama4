      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <Sidebar 
          ...
          onBeforeNavigate={(to) => {
            ...
            const workflowPages = ['/ai-assistant', '/team-builder', '/proposal-summary', '/proposal-generator', '/contract-analysis', '/proposal-team', '/public-bid-proposal-generator', '/proposal-assistant-analysis', '/proposal-assistant']
...
export default ProposalAssistantAnalysis
