...
const ConfirmTerms = () => {
  ...
  return (
    <div className="min-h-screen bg-[#0B0B0F]">
      ...
      {/* Main Content */}
      <div className="pt-20 sm:pt-32 pb-20 sm:pb-32 px-4 sm:px-6">
        <div className="max-w-4xl mx-auto">
          {/* Title Section */}
          <div className="text-center mb-6 sm:mb-10">
            <h1 className="font-poppins font-black text-xl sm:text-4xl md:text-5xl text-white mb-2 sm:mb-3">
              Automatic Renewal Terms and Conditions
            </h1>
            <p className="text-gray-400 font-poppins text-sm sm:text-lg">General Questions</p>
          </div>
