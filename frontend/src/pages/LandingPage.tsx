  ...
  return (
    <div className="h-screen bg-[#0B0B0F] flex flex-col overflow-hidden">
      ...
      <section 
        ...
        data-section="hero"
        className={`min-h-[calc(100vh-80px)] px-4 sm:px-6 relative overflow-hidden flex flex-col justify-center snap-start ${getSectionClass('hero')}`}
      >
      ...
      <section 
        ...
        className={`min-h-[calc(100vh-80px)] px-4 sm:px-6 relative overflow-hidden flex flex-col justify-center snap-start ${getSectionClass('features')}`}
      >
      ...
      <section 
        ...
        data-section="footer"
        className={`min-h-[calc(100vh-80px)] px-2 sm:px-4 relative overflow-hidden flex flex-col justify-end snap-start ${getSectionClass('footer')}`}
      >
