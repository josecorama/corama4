        ...
        <div className="flex-1 flex flex-col min-w-0">
          ...
          <main className="flex-1 p-3 sm:p-4 lg:p-6 overflow-x-hidden">
            {loading ? (
              ...
              <div className="card-gradient rounded-xl p-6 lg:p-10 border border-[#3D4F5F]">
                ...
                <div className="flex flex-col sm:flex-row justify-center gap-4">
                  <button 
                    onClick={() => navigate('/app/capability-builder')}
                  ...
                  <button 
                    onClick={() => navigate('/app/capability-builder')}
                    className="flex-1 sm:flex-none bg-[#3D4F5F] text-white font-poppins font-semibold px-8 py-4 rounded-full hover:bg-[#4D5F6F] transition-colors text-center"
                  >
                    Upload File
                  </button>
                </div>
