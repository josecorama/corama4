            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 flex-1 min-h-0 mb-3">
              ...
              <div className="bg-white rounded-2xl p-4 flex flex-col min-h-0 overflow-hidden">
                ...
                {pdfUrl ? (
                  ...
                  >
                    <img src={UploadContractPDFIcon} alt="Upload Contract" className="mb-3 h-32 sm:h-48 lg:h-[308px] w-auto" />
              ...
              <div className="bg-white rounded-2xl p-4 flex flex-col min-h-0 overflow-hidden">
                ...
                {aiFindings ? (
                  ...
                  <div className="flex-1 min-h-0 flex flex-col items-center justify-center">
                    <img src={AIFindingsIcon} alt="Contract Insights" className="mb-3 h-32 sm:h-48 lg:h-[356px] w-auto" />
